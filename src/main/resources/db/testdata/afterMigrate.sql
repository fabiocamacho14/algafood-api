...
insert into restaurante (nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, endereco_cidade_id) values ('Thai Gourmet', 10, 1, utc_timestamp, utc_timestamp, '01132-023', 'Rua Castro Silva', '835', 'Montadinha', 2);
insert into restaurante (nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, endereco_cidade_id) values ('Thai Delivery', 9.50, 1, utc_timestamp, utc_timestamp, '01132056', 'Rua Carlos da Silva', '12', 'Campo Limpo', 2);
insert into restaurante (nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, endereco_cidade_id) values ('Tuk Tuk Comida Indiana', 15, 2, utc_timestamp, utc_timestamp, '123456789', 'Rua Santos de Almeida', '5', 'Campo Sujo', 1);
