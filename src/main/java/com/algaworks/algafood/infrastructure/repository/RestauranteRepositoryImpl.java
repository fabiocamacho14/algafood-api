...
//        }
//
//        TypedQuery<Restaurante> typedQuery =  manager.createQuery(jpql.toString(), Restaurante.class);
//
//        parametros.forEach((chave, objeto) -> typedQuery.setParameter(chave,objeto));
