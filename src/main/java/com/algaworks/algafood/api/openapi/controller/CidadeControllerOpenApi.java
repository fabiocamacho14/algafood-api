...
public interface CidadeControllerOpenApi {
    ...
    @Operation(
            ...
            description = "Lista todas as cidades cadastradas no banco de dados do sistema",
            responses = {
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "200", description = "Cidade encontrada", content = @Content(
                            mediaType = "application/json", schema = @Schema(implementation = CidadeModel.class)
                    ), links = {
                            @Link(name = "self", description = "Self Link",
                                    operationRef = "https://localhost:8080/estados/{estadoId}",
                                    parameters = {
                                        @LinkParameter(name = "ID do estado", expression = "{estadoId}")
                                    }
                            ),
