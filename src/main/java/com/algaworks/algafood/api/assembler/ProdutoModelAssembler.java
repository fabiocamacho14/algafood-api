...
public class ProdutoModelAssembler extends RepresentationModelAssemblerSupport<Produto, ProdutoModel> {
    ...
    public ProdutoModel toModel(Produto produto) {
        ...
        produtoModel.add(algaLinks.linkToProdutos(produto.getRestaurante().getId(), (Boolean) null));
        produtoModel.add(algaLinks.linkToFotosProduto(produto.getRestaurante().getId(), produtoModel.getId(), "foto"));
...
//    }
    ...
    public CollectionModel<ProdutoModel> toCollectionModel(Iterable<? extends Produto> entities) {
        return super.toCollectionModel(entities)
                .add(algaLinks.linkToProdutosCollection(entities.iterator().next().getRestaurante().getId()));
    }
}
